                  ...
                  <div className="space-y-6 pr-4">
                    ...
                    <section>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        ...
                        Les données sont hébergées exclusivement en Suisse, bénéficiant d'une protection 
                ...
                <ScrollArea className="h-[60vh]">
                  <div className="space-y-6 pr-4">
                    ...
                    <section>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        L'Application est hébergée en Suisse (Infomaniak Network SA). 
                        Les données sont exclusivement stockées en Suisse, pays reconnu par la Commission 
                        Européenne comme offrant un niveau de protection adéquat des données personnelles. 
                        Aucun transfert de données hors de l'Espace Économique Européen ou de la Suisse n'a lieu.
                      </p>
                    </section>
