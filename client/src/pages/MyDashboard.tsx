...
import { format, parseISO, startOfMonth, endOfMonth, eachDayOfInterval, isSameDay, getMonth, getYear, differenceInDays } from "date-fns";
...
export default function MyDashboard() {
  ...
  const stats = useMemo(() => ({
    ...
    enCours: filteredOrders.filter(o => ["CONFIRMEE", "EN_PREPARATION", "EXPEDIEE"].includes(o.status)).length,
    livrees: filteredOrders.filter(o => ["LIVREE", "PAYEE", "TERMINEE"].includes(o.status)).length,
  }), [filteredOrders]);
